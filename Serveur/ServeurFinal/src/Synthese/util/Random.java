...
/** Une classe pour g�n�rer des nombres al�atoires � notre mani�re
 */

public class Random{

    /** Pour d�cider al�atoirement si un nombre est n�gatif
    ...
    /** Pour obtenir des nombres flottants al�atoires non sign�s
    ...
    /** Pour obtenir des nombres al�atoires sign�s
     ...
     * @return un int �gal � i + delta avec 0 < delta < n
     */
     ...
     * @param i la valeur en question
     * @param n le maximum possible pour le delta
     * @return un int �gal � i + delta avec -n < delta < n
     */
