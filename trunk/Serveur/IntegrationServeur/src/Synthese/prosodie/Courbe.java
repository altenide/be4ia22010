...
/** Une Classe pour d�crire une courbe intonative selon le rapport <code>ENST D76003 [1976]</code>.
 * <p> On dispose de  4 niveaux d'intonation, et de 5 courbes pr�d�finies : 
 * <ul>
 *      <li>courbe A : du niveau 2 au niveau 3 (d�but phrase)</li>
 ...
 * </ul></p>
 * <p><code>Rapport ENST D76003 [1976]</code> : <i>Programme de transcription phon�tique en langue fran�aise</i>
 * <ul>
 *   <li> H. Fervers </li>
 *   <li> J. Leroux  </li>
 *   <li> L. Miclet </li>
...
public class Courbe {
    ...
    private int nbPoint;            // nb de points � traiter
     ...
     * @param s le syntagme associ� � la courbe
     * @param f la fr�quence initiale de la courbe
     * @param n le nombre de points utilis� par la courbe
    ...
    /** Constructeur de courbe plus facile d'acc�s (valeur par d�faut)
    ...
    /** Pour obtenir la prochaine valeur de la courbe (it�rateur)
    ...
    /** M�thode permettant de savoir s'il reste des points � calculer sur la courbe
    ...
    /**
     * m�thodes priv�es qui calculent la fr�quence selon le type de courbe
     */
